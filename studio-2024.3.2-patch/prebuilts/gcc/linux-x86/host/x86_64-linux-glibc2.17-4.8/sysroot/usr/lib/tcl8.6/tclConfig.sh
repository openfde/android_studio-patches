...
TCL_EXTRA_CFLAGS='-g -O2 -fdebug-prefix-map=/build/tcl8.6-FupFsf/tcl8.6-8.6.10+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security -fno-unit-at-a-time -pipe -Wdate-time -D_FORTIFY_SOURCE=2'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/lib/aarch64-linux-gnu -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/lib/aarch64-linux-gnu -ltcl8.6'
...
TCL_PACKAGE_PATH='/usr/local/lib/tcltk /usr/local/share/tcltk 		  /usr/lib/tcltk/aarch64-linux-gnu /usr/lib/tcltk /usr/share/tcltk 		  /usr/lib/tcltk/tcl8.6 /usr/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/lib/aarch64-linux-gnu -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/lib/aarch64-linux-gnu -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/usr/lib/aarch64-linux-gnu/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/usr/lib/aarch64-linux-gnu/libtclstub8.6.a'
