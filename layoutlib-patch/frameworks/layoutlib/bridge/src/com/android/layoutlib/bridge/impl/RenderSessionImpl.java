...
public class RenderSessionImpl extends RenderAction<SessionParams> {
    ...
    public Result inflate() {
        ...
        try {
            ...
            sSimulatedSdk = simulatedVersion > 0 ? simulatedVersion : 33;
            if (sSimulatedSdk > 33) {
    ...
    private Result renderAndBuildResult(boolean freshRender, boolean onlyMeasure) {
        ...
        try {
            ...
            float scaleY = 1.0f;
            if (onlyMeasure) {
                // Bridge.getLog().warning(ILayoutLog.TAG_RTL_NOT_SUPPORTED, "pngcui --- onlyMeasure", null, null);
                ...
                if (mNewRenderSize || mImage == null || disableBitmapCaching) {
                    ...
                    if (enableImageResizing || mNewRenderSize) {
                        disposeImageSurface();
                        // Bridge.getLog().warning(ILayoutLog.TAG_RTL_NOT_SUPPORTED, "pngcui --- disposeImageSurface", null, null);
                    }
                    ...
                    // Bridge.getLog().warning(ILayoutLog.TAG_RTL_NOT_SUPPORTED, "pngcui --- mRenderer.setup", null, null);
                }
                ...
                // Bridge.getLog().warning(ILayoutLog.TAG_RTL_NOT_SUPPORTED, "pngcui --- draw...", null, null);
            ...
            // success!
            // Bridge.getLog().warning(ILayoutLog.TAG_RTL_NOT_SUPPORTED, "pngcui --- success", null, null);
            return SUCCESS.createResult();
        } catch (Throwable e) {
            // get the real cause of the exception.
            Throwable t = e;
            ...
            // Bridge.getLog().warning(ILayoutLog.TAG_RTL_NOT_SUPPORTED, "pngcui --- failed", null, null);
