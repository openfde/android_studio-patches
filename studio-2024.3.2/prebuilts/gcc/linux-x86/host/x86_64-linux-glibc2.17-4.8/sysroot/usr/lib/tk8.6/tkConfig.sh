...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/lib/aarch64-linux-gnu -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/usr/lib/aarch64-linux-gnu -ltk8.6'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/lib/aarch64-linux-gnu -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/usr/lib/aarch64-linux-gnu -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/usr/lib/aarch64-linux-gnu/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/usr/lib/aarch64-linux-gnu/libtkstub8.6.a'
